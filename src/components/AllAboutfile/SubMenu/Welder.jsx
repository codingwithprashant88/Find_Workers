...
function Welder() {
   const [ragisterWelder, setRagisterWelder] = useState({
          name: "",
          age: "",
          phone: "",
          email: "",
  ...
  const allTypes = [
    " fabrication (फैब्रिकैशन)",
  ];

  const handleChange = (e) => {
            const { name, value } = e.target;
        
            setRagisterWelder((prev) => ({
              ...prev,
              [name]: value,
            }));
          };
          ...
          const handleSubmit = async (e) => {
            ...
            try {
              const { name, age, phone, email, category } = ragisterWelder;
              ...
              const response = await fetch(url, {
                ...
                body: JSON.stringify(ragisterWelder),
              });
        ...
        <div className="relative flex flex-col items-center mt-10">
          <div className="w-screen  bg-blue-100 p-10">
            ...
            <div className="bg-[#f5f4ff] mx-auto flex max-w-6xl flex-col items-center gap-6 rounded-lg bg-neutral-primary-soft p-20 lg:pb-10 lg:pt-10 shadow-sm md:flex-row md:gap-10">
              ...
              <img
                src="https://d3e1m60ptf1oym.cloudfront.net/aeca1882-4828-41a0-b166-1773be696944/Brett-Cole-India-01934_xgaplus.jpg"
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <select  onChange={handleChange}
                    name="category"
                    value={ragisterWelder.category} className="w-full rounded-xl border border-gray-300 px-4 py-2 bg-white focus:ring-2 focus:ring-blue-500 outline-none">
