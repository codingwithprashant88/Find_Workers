...
function Painter() {
  const [ragisterPainter, setRagisterPainter] = useState({
    name: "",
    age: "",
    phone: "",
    email: "",
  ...
  const AllItem = [
    " Enamel painter (इनेमल पेंटर)",
    "POP (पी ओ पी)",
    "Stencils (स्टेन्सिल)",
    "Water proofing (वाटर प्रूफ)",
    "Putty (पुट्टी)",
    "Textured wall (टेक्स्चर दीवार)",
    "Wood polishing (लकड़ी पॉलिश)",
    "Helper (हेल्पर)",
  ];
  ...
  const handlSubmit = async (e) => {
    e.preventDefault();
    const { name, age, phone, email, category } = ragisterPainter;
    ...
    try {
      ...
      const response = await fetch(url, {
        ...
        body: JSON.stringify(ragisterPainter),
      });
        ...
        <div className="relative flex flex-col items-center mt-10">
          <div className="w-screen  bg-blue-100 p-10">
            ...
            <div className="bg-[#f5f4ff] mx-auto flex max-w-6xl flex-col items-center gap-6 rounded-lg bg-neutral-primary-soft p-20 lg:pb-10 lg:pt-10 shadow-sm md:flex-row md:gap-10">
              ...
              <img
                src="https://www.timminspainting.com/wp-content/uploads/2023/07/professional_paints_a_blue_wall-825x450.webp"
              ...
              <form onSubmit={handlSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <select
                    onChange={handleChange}
                    name="category"
                    value={ragisterPainter.category}
