...
function Mason() {
  const [registerMason, setRegisterMason] = useState({
    name: "",
    age: "",
    email: "",
    phone: "",
  ...
  const AllService = [
    "Brick mason (ईट मिस्त्री)",
    "Lanter Mason (लेन्टर मिस्त्री)",
    "Plastering Mason (प्लास्टर् मिस्त्री)",
    "Stone mason (पथर मिस्त्री)",
    "Tiles Mason (टाइल्स मिस्त्री)",
    "Cement Concrete Mason (कान्क्रीट मिस्त्री)",
    "Bar bender (सरिया मिस्त्री)",
    "shuttering (शटरिंग मिस्त्री)",
    "Marbles Mason (मार्बल मिस्त्री)",
    "Flooring (फर्श मिस्त्री)",
    "composite Mason (राजमिस्त्री)",
    "Garters/Columns Mason (पिलर मिस्त्री)",
    "Lime Concrete Mason (चुना मिस्त्री)",
    "fitter (फिटर)",
    "scaffolding (स्काफोल्डिंग)",
    "Reinforcement fitter (रएंफोर्रसमेंट फिटर)",
  ];
 ...
 const navigate = useNavigate(); 
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const {name, age, email, phone, category} = registerMason;
     if(!name || !email || !phone || !category || !age){
     ...
     try {
        ...
        const response = await fetch(url, {
          ...
          body: JSON.stringify(registerMason)
        })
        ...
        <div className="relative flex flex-col items-center mt-10">
          <div className="w-screen  bg-blue-100 p-10">
            ...
            <div className="bg-[#f5f4ff] mx-auto flex max-w-6xl flex-col items-center gap-6 rounded-lg bg-neutral-primary-soft p-20 lg:pb-10 lg:pt-10 shadow-sm md:flex-row md:gap-10">
              ...
              <img
                src="https://media.istockphoto.com/id/622800826/photo/bricklayer-worker-installing-brick-masonry-on-exterior-wall.jpg?s=612x612&w=0&k=20&c=2Wlk0lZpGZEtZ-WYqAVPCgOOK5ELFXpUH1H24iAKRKU="
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <select
                    name="category"
                    onChange={handleChange}
                    value={registerMason.category}
                    className="w-full rounded-xl border border-gray-300 px-4 py-2 bg-white focus:ring-2 focus:ring-blue-500 outline-none"
                  >
                    <option value="">Select category</option>
                    {AllService.map((category, index) => (
