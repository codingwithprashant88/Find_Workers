...
function Electrician() {
   const [ragisterElectician, setRagisterElectician] = useState({
    name: "",
    age: "",
    phone: "",
    email: "",
  ...
  const allTypes = [
    "    Drill & hanging (ड्रिल)",
    "Light (लाइट)",
    "Switch & socket (स्विच और साकिट)",
    "Appliances Installation (उपकरण स्थापना)",
    "Electric System diagnosis (इलेक्ट्रिक जांच)",
    "Power Failure Check (पॉवर जांच)",
    "Fan (पंखा)",
    "MCB & fuse (फ्यूज़ और एमसीबी)",
    "Wiring (वाइरिंग)",
    "Chrome Plated Fittings (क्रोम फिटिंग)",
    "Electric Panels (पैनल)",
    "electrician helper (हेल्पर)",
  ];

  const handleChange = (e) => {
      const { name, value } = e.target;
  
      setRagisterElectician((prev) => ({
        ...prev,
        [name]: value,
      }));
    };
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const { name, age, phone, email, category } = ragisterElectician;
        ...
        const response = await fetch(url, {
          ...
          body: JSON.stringify(ragisterElectician),
        });
        ...
        <div className="relative flex flex-col items-center mt-10">
          <div className="w-screen  bg-blue-100 p-10">
            ...
            <div className="bg-[#f5f4ff] mx-auto flex max-w-6xl flex-col items-center gap-6 rounded-lg bg-neutral-primary-soft p-20 lg:pb-10 lg:pt-10 shadow-sm md:flex-row md:gap-10">
              ...
              <img
                src="https://img.freepik.com/free-photo/man-electrical-technician-working-switchboard-with-fuses_169016-24062.jpg?semt=ais_hybrid&w=740&q=80"
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                     onChange={handleChange}
                    name="phone"
                    value={ragisterElectician.phone}
                    maxLength={10}
                      type="tel"
                  ...
                  <div>
                    ...
                    <input
                     onChange={handleChange}
                    name="email"
                    value={ragisterElectician.email}
                      type="email"
                ...
                <div>
                  ...
                  <select  onChange={handleChange}
                    name="category"
                    value={ragisterElectician.category} className="w-full rounded-xl border border-gray-300 px-4 py-2 bg-white focus:ring-2 focus:ring-blue-500 outline-none">
