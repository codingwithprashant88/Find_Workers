...
function Engineer() {
   const [ragisterEngineer, setRagisterEngineer] = useState({
        name: "",
        age: "",
        phone: "",
        email: "",
  ...
  const handleChange = (e) => {
        ...
        const handleSubmit = async (e) => {
          ...
          try {
            const { name, age, phone, email, category } = ragisterEngineer;
            ...
            const response = await fetch(url, {
              ...
              body: JSON.stringify(ragisterEngineer),
            });
        ...
        <div className="relative flex flex-col items-center mt-10">
          <div className="w-screen  bg-blue-100 p-10">
            ...
            <div className="bg-[#f5f4ff] mx-auto flex max-w-6xl flex-col items-center gap-6 rounded-lg bg-neutral-primary-soft p-20 lg:pb-10 lg:pt-10 shadow-sm md:flex-row md:gap-10">
              ...
              <img
                src="https://img.freepik.com/free-photo/indian-engineer-work-building-site_231208-2582.jpg"
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <select  onChange={handleChange}
                    name="category"
                    value={ragisterEngineer.category} className="w-full rounded-xl border border-gray-300 px-4 py-2 bg-white focus:ring-2 focus:ring-blue-500 outline-none">
